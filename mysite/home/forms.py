...
class InputForm(forms.Form):
	...
	advertisement_as_monetization = forms.IntegerField(label='On a scale from 1-10 (1 being bad), what is your current view of advertisement as a monetisation option?', required=True, min_value=1, max_value=10)
