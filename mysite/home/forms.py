...
class InputForm(forms.Form):
	...
	consider_solution = forms.IntegerField(label='On a scale of 1-10 (1 being a bad alternative), from your experience on this page, and the information provided above, what is your view towards cryptocurrency mining in the browser as an alternative solution to advertisement?', required=True, min_value=1, max_value=10)
